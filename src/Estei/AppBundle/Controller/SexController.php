...
use Estei\AppBundle\Entity\Sex;
use Estei\AppBundle\Form\SexType;
...
class SexController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EsteiAppBundle:Sex')->findAll();

        return $this->render('EsteiAppBundle:Sex:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EsteiAppBundle:Sex:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EsteiAppBundle:Sex')->find($id);
        ...
        return $this->render('EsteiAppBundle:Sex:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EsteiAppBundle:Sex:edit.html.twig', array(
            'entity'      => $entity,
