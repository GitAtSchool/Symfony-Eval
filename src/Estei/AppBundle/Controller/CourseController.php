...
use Estei\AppBundle\Entity\Course;
use Estei\AppBundle\Form\CourseType;
...
class CourseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EsteiAppBundle:Course')->findAll();

        return $this->render('EsteiAppBundle:Course:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EsteiAppBundle:Course:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EsteiAppBundle:Course')->find($id);
        ...
        return $this->render('EsteiAppBundle:Course:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EsteiAppBundle:Course:edit.html.twig', array(
            'entity'      => $entity,
